...
//   async findOne (id: string, entidadId: number): Promise<MatrizContratacion> {
//     try {
...
//   async update (id: any, entidadId: any, changes: any): Promise<MatrizContratacion> {
//     try {
...
//   async delete (id: any, entidadId: any): Promise<MatrizContratacion> {
//     try {
//       const obra = await this.findOne(id, entidadId)
