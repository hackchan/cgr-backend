...
import { Column, Entity, ManyToOne, PrimaryColumn, Unique, JoinColumn, CreateDateColumn, UpdateDateColumn } from 'typeorm'
...
export class MatrizCatastroDetalle {
  @PrimaryColumn({ type: 'numeric', name: 'numero_predial' })
  @ManyToOne(() => MatrizCatastro, { nullable: false })
  @JoinColumn()
