...
router.get('/:id', getRole as RequestHandler)
router.post('/', createRole as RequestHandler)
router.patch('/:id', updateRole as RequestHandler)
router.delete('/:id', deleteRole as RequestHandler)
