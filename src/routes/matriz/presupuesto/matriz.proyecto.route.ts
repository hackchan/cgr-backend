...
import { createProyecto, createUpdateProyecto, deleteProyecto, getProyecto, getProyectos, updateProyecto, getProyectoByEntidad } from '../../../controllers/matriz/presupuesto/matriz.proyecto.controller'
...
router.get('/entidad/:id', passport.authenticate('jwt', { session: false, failWithError: true }), checkRoles('ADMIN', 'JEDI', 'ENTIDAD', 'INFORMACION', 'ANALISIS', 'URI'), isAdmin(), getProyectoByEntidad as RequestHandler)
