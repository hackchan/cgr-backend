...
export class dbDiari1667921101138 implements MigrationInterface {
  name = 'dbDiari1667921101138'
  ...
  public async up (queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query('CREATE TABLE "matriz_ies" ("id" int NOT NULL IDENTITY(1,1), "semestre_reportado" int NOT NULL, "codigo" nvarchar(255) NOT NULL, "nombre_estudiante" nvarchar(255) NOT NULL, "no_documento" nvarchar(255) NOT NULL, "programa" nvarchar(255) NOT NULL, "valor_semestre_sin_descuentos" decimal(19,2) NOT NULL CONSTRAINT "DF_72614549a6a3f8dcb9049b7afee" DEFAULT 0, "recargo" decimal(19,2) NOT NULL CONSTRAINT "DF_efdb1792622728311226db07490" DEFAULT 0, "descuentos" decimal(19,2) NOT NULL CONSTRAINT "DF_533b81ec7641baebcb6d8147374" DEFAULT 0, "tipo_de_descuento" nvarchar(255) NOT NULL CONSTRAINT "DF_2891595a07bc94206d38d12f2ce" DEFAULT \'NO APLICA\', "dia_corte" int, "mes_corte" int, "anio_corte" int, "alerta" bit, "createdAt" datetime2 NOT NULL CONSTRAINT "DF_f6d7d13572bdf6df75f53dcf2b7" DEFAULT getdate(), "updatedAt" datetime2 NOT NULL CONSTRAINT "DF_88b7f13b49807e9c851ebef8762" DEFAULT getdate(), "tipo_documento" int NOT NULL, "sede" int NOT NULL, "semestre" int NOT NULL, "residencia" int NOT NULL, "estrato" int NOT NULL, "user_alerta" int, "entidad_id" int NOT NULL, "user_operation" int, CONSTRAINT "matrizIes_unique" UNIQUE ("codigo", "entidad_id"), CONSTRAINT "PK_d366d40aa199f62111986c74b51" PRIMARY KEY ("id"))')
    ...
    await queryRunner.query('ALTER TABLE "matriz_ies" ADD CONSTRAINT "FK_40c2769e62c212880877fa508e0" FOREIGN KEY ("semestre") REFERENCES "semestre"("id") ON DELETE NO ACTION ON UPDATE NO ACTION')
  ...
  public async down (queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query('ALTER TABLE "matriz_ies" DROP CONSTRAINT "FK_40c2769e62c212880877fa508e0"')
