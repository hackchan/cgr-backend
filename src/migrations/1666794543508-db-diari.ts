...
export class dbDiari1666794543508 implements MigrationInterface {
  ...
  public async up (queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query('CREATE TABLE "role_user" ("id" int NOT NULL IDENTITY(1,1), "createdAt" datetime2 NOT NULL CONSTRAINT "DF_93a2f278af380b25755ce685cbd" DEFAULT getdate(), "updatedAt" datetime2 NOT NULL CONSTRAINT "DF_32682ea64e35aaa5eb8f0413629" DEFAULT getdate(), "userId" int, "roleId" int, CONSTRAINT "PK_e3583d40265174efd29754a7c57" PRIMARY KEY ("id"))')
    ...
    await queryRunner.query('CREATE TABLE "user_entidad" ("id" int NOT NULL IDENTITY(1,1), "createdAt" datetime2 NOT NULL CONSTRAINT "DF_c8a22ba5f3faf47de4b0c7c57f3" DEFAULT getdate(), "updatedAt" datetime2 NOT NULL CONSTRAINT "DF_dcf25dcc4374df840945eae4a62" DEFAULT getdate(), "userId" int, "entidadId" int, CONSTRAINT "PK_95cb65b12c77326803739037137" PRIMARY KEY ("id"))')
    await queryRunner.query('CREATE TABLE "user" ("id" int NOT NULL IDENTITY(1,1), "uuid" uniqueidentifier NOT NULL, "createdAt" datetime2 NOT NULL CONSTRAINT "DF_e11e649824a45d8ed01d597fd93" DEFAULT getdate(), "updatedAt" datetime2 NOT NULL CONSTRAINT "DF_80ca6e6ef65fb9ef34ea8c90f42" DEFAULT getdate(), "name" nvarchar(255) NOT NULL, "last_name" nvarchar(255) NOT NULL, "phone" nvarchar(255) NOT NULL, "email" nvarchar(255) NOT NULL, "image" nvarchar(255), "active" bit NOT NULL CONSTRAINT "DF_843f46779f60b45032874be95b3" DEFAULT 0, "auth_id" int, "type_id" int NOT NULL, CONSTRAINT "UQ_8e1f623798118e629b46a9e6299" UNIQUE ("phone"), CONSTRAINT "UQ_e12875dfb3b1d92d7d7c5377e22" UNIQUE ("email"), CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))')
    await queryRunner.query('CREATE UNIQUE INDEX "REL_56d00ec31dc3eed1c3f6bff4f5" ON "user" ("auth_id") WHERE "auth_id" IS NOT NULL')
    await queryRunner.query('CREATE TABLE "auth" ("id" int NOT NULL IDENTITY(1,1), "uuid" uniqueidentifier NOT NULL, "createdAt" datetime2 NOT NULL CONSTRAINT "DF_392eca727f7ab94f76fe3d687f8" DEFAULT getdate(), "updatedAt" datetime2 NOT NULL CONSTRAINT "DF_f9add8546ebede2f8f45002776a" DEFAULT getdate(), "username" nvarchar(255) NOT NULL, "password" nvarchar(255) NOT NULL, "apikey" nvarchar(255), "role" ntext NOT NULL CONSTRAINT "DF_7398d6556b440ff388503c5885d" DEFAULT \'\', "recovery_token" nvarchar(255), CONSTRAINT "UQ_366ebf23d8f3781bb7bb37abbd1" UNIQUE ("username"), CONSTRAINT "PK_7e416cf6172bc5aec04244f6459" PRIMARY KEY ("id"))')
    ...
    await queryRunner.query('ALTER TABLE "user_entidad" ADD CONSTRAINT "FK_7274305eb978968c05cdbf15661" FOREIGN KEY ("userId") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION')
    await queryRunner.query('ALTER TABLE "user_entidad" ADD CONSTRAINT "FK_f5cbae9da5df08204723b2fe9ec" FOREIGN KEY ("entidadId") REFERENCES "entidad_control"("id") ON DELETE NO ACTION ON UPDATE NO ACTION')
  ...
  public async down (queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query('ALTER TABLE "user_entidad" DROP CONSTRAINT "FK_f5cbae9da5df08204723b2fe9ec"')
    await queryRunner.query('ALTER TABLE "user_entidad" DROP CONSTRAINT "FK_7274305eb978968c05cdbf15661"')
    ...
    await queryRunner.query('DROP TABLE "user_entidad"')
