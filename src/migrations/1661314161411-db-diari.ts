...
export class dbDiari1661314161411 implements MigrationInterface {
    name = 'dbDiari1661314161411'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "entidad_control" ("id" int NOT NULL IDENTITY(1,1), "nit" int NOT NULL, "name" nvarchar(255) NOT NULL, "doctec" bit, "cgn" nvarchar(255), "categoria_id" int, "subsector_id" int NOT NULL, "user_id" int NOT NULL, CONSTRAINT "UQ_5a32fe49fce8b3ddeafe3608698" UNIQUE ("nit"), CONSTRAINT "PK_4ccd2862deb3f64fa3fac923f22" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "entidad_control" ADD CONSTRAINT "FK_322ca2301c76e926e4358c50af2" FOREIGN KEY ("user_id") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "entidad_control" DROP CONSTRAINT "FK_322ca2301c76e926e4358c50af2"`);
