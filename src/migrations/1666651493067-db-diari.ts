...
export class dbDiari1666651493067 implements MigrationInterface {
    name = 'dbDiari1666651493067'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "soportes" ("id" int NOT NULL IDENTITY(1,1), "name" nvarchar(255) NOT NULL, "obra_id" int NOT NULL, "tipo_soporte_id" int NOT NULL, CONSTRAINT "PK_fee1f91a459288b377a32746f77" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "entidad_control" ("id" int NOT NULL IDENTITY(1,1), "nit" nvarchar(255) NOT NULL, "name" nvarchar(255) NOT NULL, "doctec" bit, "cgn" nvarchar(255), "categoria_id" int, "subsector_id" int NOT NULL, "municipio_id" int NOT NULL, CONSTRAINT "UQ_5a32fe49fce8b3ddeafe3608698" UNIQUE ("nit"), CONSTRAINT "PK_4ccd2862deb3f64fa3fac923f22" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "user_entidades_entidad_control" ADD CONSTRAINT "FK_9e92c96f814db420b92134ce92b" FOREIGN KEY ("entidadControlId") REFERENCES "entidad_control"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
    }
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP TABLE "soportes"`);
